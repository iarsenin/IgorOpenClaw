...
- 2026-03-27 | **Direct instructions are pre-approved.** When Igor says "put X in my calendar", "send X to Y", "call Z" — the instruction itself is the approval. Do not ask for confirmation. Just execute. Only ask when YOU are proposing an action Igor didn’t request.
